...
import com.github.jamesdeperio.moviedb.android.databinding.ListHomeWideItemBinding
...
class HomeItemWideViewHolder(
    private val adapter: HomeAdapter<HomeItem>,
    private val context: Context?
): ViewHolder() {

    private lateinit var binding: ListHomeWideItemBinding

    @SuppressLint("UseCompatLoadingForDrawables")
    override fun onBindViewHolder(itemView: View, position: Int) {
        binding = ListHomeWideItemBinding.bind(itemView)
