package com.github.jamesdeperio.moviedb.model.domain.airingtodaytv

import kotlinx.serialization.SerialName
import kotlinx.serialization.Serializable

@Serializable
data class AiringTodayData (
   ...
   @SerialName("origin_country") var originCountry : List<String>?=null,
